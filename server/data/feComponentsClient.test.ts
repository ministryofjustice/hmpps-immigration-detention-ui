...
import FeComponentsClient, { AvailableComponent, Component } from './feComponentsClient'
...
describe('Components service', () => {
  ...
  describe('getComponent', () => {
    beforeEach(() => {
      componentsClient = new FeComponentsClient(null) as jest.Mocked<FeComponentsClient>
